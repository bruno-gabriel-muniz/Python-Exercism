...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    # calculando a criticidade do reator
    criticalidade = temperature * neutrons_produced_per_second/threshold
    # verificando se ela é baixa, normal ou perigosa
    if criticalidade < 0.9:
        status = 'LOW'
    elif criticalidade < 1.1:
        status = 'NORMAL'
    else:
        status = 'DANGER'
    return status
